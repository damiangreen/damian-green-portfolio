      ...
      <main>
        ...
        >
          <div className="p-5 text-black bg-white bg-opacity-50 rounded-xl">
            <h2 className="px-5 pt-5 text-4xl text-center uppercase mb-1 font-mono tracking-wide">
              Damian Green
            </h2>
          ...
          <div className="flex mb-8 leading-relaxed">
            ...
            <div className="flex-1 flex">
              <div className="m-auto animate-pulse hover:animate-off flex flex-col ">
                ...
                <div className="text-center">C.V.</div>
              </div>
            </div>
          </div>
          <div className="flex mb-4 leading-relaxed flex-column">
            <div>
              I give back to the developer community by helping to answer
              questions on StackOverflow. My profile can be found here.
            </div>
            <div>
        ...
        <div className="max-w-lg m-auto">
          ...
          <p className="mb-8">
            I built this site partly to learn NextJS /{" "}
            <Link href="https://tailwindcss.com/">Tailwind</Link> / Vercel and
            partly as a web presence.{" "}
          </p>
          <p className="mb-8">
          ...
          <p className="mb-8">
            Background images were generated with Stable Diffusion.
          </p>
        </div>
      </main>
